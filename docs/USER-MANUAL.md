...
- **+ Event**: a button on each customer row (before "View") that opens the New Event dialog with that customer already selected — the quickest way to log or schedule an event without leaving the Customers page.
